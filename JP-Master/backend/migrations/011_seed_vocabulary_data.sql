-- ============================================================
-- Migration: Seed initial vocabulary data
-- Description: Insert sample vocabulary for all JLPT levels (N5-N1) and Special (SP)
-- Date: 2026-01-07
-- Note: Only inserts if vocabulary table is empty to avoid duplicates
-- ============================================================

-- Only seed if the table is empty
DO $$
BEGIN
    IF (SELECT COUNT(*) FROM Vocabulary) = 0 THEN
        -- Level N5 vocabulary (10 words)
        ...
        -- Level SP (Specialist) vocabulary (10 words) - IT terminology
        INSERT INTO Vocabulary (word, kana, meaning, jlpt_level, topic) VALUES
        ...
        RAISE NOTICE 'Seeded 60 vocabulary entries';
    ELSE
        RAISE NOTICE 'Vocabulary table already contains data, skipping seed';
    END IF;
END $$;

-- Record this migration
INSERT INTO migrations_history (migration_name, description)
VALUES ('011_seed_vocabulary_data', 'Seed initial vocabulary data for all JLPT levels (N5-N1) and Special (SP)')
